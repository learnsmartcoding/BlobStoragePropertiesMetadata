...
namespace LearnSmartCoding.BlobStoragePropertiesMetadata
{
    class Program
    {
        // TODO: Add your connection string here
        private static readonly string _connectionString = "DefaultEndpointsProtocol=https;AccountName=learnsmartcoding;AccountKey=m3ZAYhsaKNOh/6U6XSQaGFjdkChMPXwUvI+qaUesPk/MoL8d4R+qNlxWiZdjAQTXmNKH4sVZpKBI+AStPH/73g==;EndpointSuffix=core.windows.net";

        private static readonly string _blobContainerName = "demo";
        ...
        private static async Task SetBlobMetadataAsync(BlobClient blobClient)
        {
            ...
            metadata.Add("firstName", "Karthik Kannan");
